        ...
        <main>
            ...
            <div id="content1">
                ...
                <div class="logout-top">
                    ...
                    <a href="logout.php"><svg id="logout" width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="content">
                    ...
                    <table class="customTable">
                        <thead>
                        <tr class="titletable">
                            <th>Adresse email : <svg class="chevron chevron1" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M4 15L12 7L20 15" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg></th>
                            <th class="mobile-display">Date d'inscription : <svg class="chevron chevron2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M4 15L12 7L20 15" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg></th>
                            <th></th>
                        </tr>
